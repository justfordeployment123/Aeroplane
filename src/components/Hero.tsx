...
export const Hero = () => {
    return (
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
            ...
            {/* 2. linear Overlay (Fades from black on the left to transparent on the right) */}
            <div className="absolute inset-0 bg-linear-to-r from-aero-dark via-aero-dark/90 to-transparent z-0" />

            {/* 3. Blue Tech Glow */}
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-150 h-150 bg-aero-blue/20 rounded-full blur-[150px] opacity-60 pointer-events-none z-0" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-left">
                    ...
                    >
                        FP-98 Large <br />
                        <span className="bg-clip-text text-transparent bg-linear-to-r from-aero-blue to-aero-purple">Fixed Wing UAV</span>
                    </motion.h1>
