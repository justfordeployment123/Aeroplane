...
// Make sure your .env is configured with MONGODB_URI before running.

require("dotenv").config();
const mongoose = require("mongoose");
const Product = require("../models/Product");

// ── Seed data (migrated from product.ts + en.json) ───────────────────────────
...
const PRODUCTS = [
    {
        ...
        img: { url: "/images/products/fp-98.png", publicId: "" },
        paramImg: { url: "/images/products/fp-98-params.png", publicId: "" },
        video: "/videos/1.mp4",
        isVisible: true,
    },
    {
        ...
        img: { url: "/images/products/fp-985.png", publicId: "" },
    ...
    },
    {
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/fp-981c.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: "/videos/3.mp4",
        isVisible: true,
    },
    {
        ...
        img: { url: "/images/products/fp-981a.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: "/videos/4.mp4",
        isVisible: true,
    },
    {
        ...
        highlights: ["Unattended", "Autonomous Take-off and Landing", "Full-time Monitoring", "Automatic Loading and Unloading"],
        specs: [
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/fp-980-7b.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: "/videos/5.mp4",
        isVisible: true,
    },
    ...
    // ── Special ───────────────────────────────────────────────────────────────
    {
        ...
        highlights: ["Long Endurance", "Extended Load", "Wide Operating Range", "Vertical Take-off and Landing"],
        specs: [
        ...
        img: { url: "/images/products/fp-981cs.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: null,
        isVisible: true,
    },
    ...
    // ── Ground Station ────────────────────────────────────────────────────────
    {
        ...
        highlights: ["Highly Integrated", "Support Expansion Suite", "All Aviation Aluminum Body Light Weight", "Customized Communication Links"],
        specs: [
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/fp-980-1.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: null,
        isVisible: true,
    },
    {
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/fp-980-2.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: null,
        isVisible: true,
    },
    {
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/fp-980-3b.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: null,
        isVisible: true,
    },
    {
        ...
        highlights: ["Land Fast Mobility", "Rapid Deployment", "Light and Flexible", "Type of Driver: C1 Driver's License"],
        specs: [
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/fp-980-3c.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: null,
        isVisible: true,
    },
    ...
    // ── Control System ────────────────────────────────────────────────────────
    {
        ...
        highlights: ["Real-time Situation Display", "Takeoff and Landing Control", "Risk Warning", "Flow Control"],
        specs: [
        ...
        applications: ["Civil Logistic", "Emergency Rescue", "Industry Service"],
        img: { url: "/images/products/uav-ocs.png", publicId: "" },
        paramImg: { url: "", publicId: "" },
        video: null,
        isVisible: true,
    },
...
// ── Also update the categoryId enum in Product model if needed ────────────────
// The static data uses: "uav", "special", "ground-station", "control-system"
// Make sure your Product.js model enum matches these exactly.
...
async function seed() {
    ...
    if (existing > 0) {
        console.log(`⚠️   ${existing} product(s) already exist in the database.`);
        console.log("     Choose an option:");
        console.log("     --fresh   Delete all existing products and re-seed");
        console.log("     --skip    Exit without making changes (default)\n");
        ...
        if (flag === "--fresh") {
            ...
            console.log("↩️   Exiting without changes.");
    ...
    for (const p of PRODUCTS) {
        ...
        console.log(`  ✓  [${doc.categoryId}] ${doc.name}`);
    }
